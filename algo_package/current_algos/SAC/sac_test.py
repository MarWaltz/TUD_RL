...
sys.path.append("C:/Users/MWaltz/Desktop/Forschung/RL/Implementations/algos/continuing/main versions/relevant/common")
...
if __name__ == "__main__":
    test(env_str="LCP", critic_weights="TD3_Agent_critic_weights.pth", actor_weights="TD3_Agent_actor_weights.pth", device="cpu")
