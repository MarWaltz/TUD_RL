...
class World(object):
    ...
    def render_waypoints(self, surface, world_to_pixel_width):

        current_waypoint = self.town_map.get_waypoint(self.hero_actor.get_location(), project_to_road=True)
    ...
    def render(self, display):
        ...
        #self.render_waypoints(self.actors_surface, self.map_image.world_to_pixel_width)
