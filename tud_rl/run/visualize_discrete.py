...
def visualize_policy(env: gym.Env, agent: BaseAgent, c: Configfile):
...
def test(c: Configfile, agent_name: str, dqn_weights: str):
    # init env
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dqn_weights", type=str,
                        default="/home/niklaspaulig/Dropbox/TU Dresden/experiments/SCDQN_b_PathFollower-v0_2000-5-seiun-full-5th_2022-04-02_88341/SCDQN_b_weights.pth")
